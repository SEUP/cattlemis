<div class="panel-group">
    <div class="panel panel-default">
        ...
        <div id="collapse1" class="panel-collapse collapse in">
            <div class="panel-body">
                ...
                <li><a href="{{$PREFIX}}/charts/pie/อาชีพการเลี้ยงโคเนื้อ(อาชีพหลัก-เสริม)/cattle_job">อาชีพการเลี้ยงโคเนื้อ(อาชีพหลัก-เสริม)</a>
                </li>
                <li>
                    <a href="{{$PREFIX}}/charts/normal/เฉลี่ยรายได้รวมของครอบครัว/income_range">เฉลี่ยรายได้รวมของครอบครัว</a>
                </li>
                <li>
                    <a href="{{$PREFIX}}/charts/normal/รายได้จากการประกอบอาชีพของเกษตรกร/jobtypes">รายได้จากการประกอบอาชีพของเกษตรกร</a>
                </li>
                <li>
                    <a href="{{$PREFIX}}/charts/range-farmowner/รายได้เฉลี่ยต่อปีของการขายโคเนื้อ/avg_cattle_income/50000/200000/3?withNull=true&nullText=ยังไม่ได้ขาย">รายได้เฉลี่ยต่อปีของการขายโคเนื้อ</a>
                </li>
            </div>
        </div>
    </div>
    <div class="panel panel-default">
        ...
        <div id="collapse2" class="panel-collapse collapse in">
            <div class="panel-body">
                <li><a href="{{$PREFIX}}/charts/normal/วัตถุประสงค์ของการเลี้ยงโคเนื้อ/farm_purposes">วัตถุประสงค์ของการเลี้ยงโคเนื้อ</a>
                </li>
                <li><a href="{{$PREFIX}}/charts/pie/การทำประวัติโคเนื้อ/farm_record">การทำประวัติโคเนื้อ</a></li>
                <li><a href="{{$PREFIX}}/charts/cattle/">จำนวนโคเนื้อที่เลี้ยง</a></li>
                <li>
                    <a href="{{$PREFIX}}/charts/normal/ประสบการณ์การเลี้ยงโคเนื้อ/farm_exp">ประสบการณ์การเลี้ยงโคเนื้อ</a>
                </li>
                <li>
                    <a href="{{$PREFIX}}/charts/normal/เป้าหมายการเลี้ยงในอนาคต/farm_future">เป้าหมายการเลี้ยงในอนาคต</a>
                </li>
                <li><a href="{{$PREFIX}}/charts/double/การขึ้นทะเบียนฟาร์มกับภาครัฐ/farm_register_status">การขึ้นทะเบียนฟาร์มกับภาครัฐ</a>
                </li>
                <li>
                    <a href="{{$PREFIX}}/charts/multi-choice/การเกิดโรคในฟาร์ม/abortion,tuberculosis,foot_mouth_disease,disease_other">การเกิดโรคในฟาร์ม</a>
                </li>
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse3" class="panel-collapse collapse in">
            <div class="panel-body">
                <li><a href="{{$PREFIX}}/charts/range-farmowner/จำนวนแรงงานภายในครอบครัว/family_workers_amount/1/5/4">จำนวนแรงงานภายในครอบครัว</a>
                </li>
                <li><a href="{{$PREFIX}}/charts/range-farmowner/จำนวนแรงงานภายนอก/external_workers_amount/1/5/4">จำนวนแรงงานภายนอก</a>
                </li>
                <li>
                    <a href="{{$PREFIX}}/charts/pie/ลักษณะการเลี้ยงโคเนื้อ/take_care_types">ลักษณะการเลี้ยงโคเนื้อ</a>
                </li>
                <li>
                    <a href="{{$PREFIX}}/charts/double/พื้นที่ที่ใช้ในการเลี้ยงโคเนื้อ/use_land/">พื้นที่ที่ใช้ในการเลี้ยงโคเนื้อ</a>
                </li>
                <li><a href="{{$PREFIX}}/charts/pie/อาหารที่ใช้เลี้ยงโคเนื้อ/feed_types">อาหารที่ใช้เลี้ยงโคเนื้อ</a>
                </li>
                <li><a href="{{$PREFIX}}/charts/pie/การให้แร่ธาตุก้อน/minerals_feed">การให้แร่ธาตุก้อน</a></li>
                <li><a href="{{$PREFIX}}/charts/double/การสำรองฟางข้าว หรือเปลือกข้าวโพด/feedstock">การสำรองฟางข้าว
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse4" class="panel-collapse collapse in">
            <div class="panel-body">
                <li>
                    <a href="{{$PREFIX}}/charts/pie/การผสมพันธุ์โคเนื้อในฟาร์ม/farm_breeding_type">การผสมพันธุ์โคเนื้อในฟาร์ม</a>
                </li>
                <li>
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse5" class="panel-collapse collapse in">
            <div class="panel-body">
                <li><a href="{{$PREFIX}}/charts/budget/">เงินทุนการเลี้ยงโคเนื้อ</a></li>
            </div>
        </div>
    </div>
    <div class="panel panel-default">
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse7" class="panel-collapse collapse in">
            <div class="panel-body">
                <li><a href="{{$PREFIX}}/charts/suggestion">ตารางปัญหา อุปสรรคและข้อเสนอแนะ</a></li>
            </div>
        </div>
    </div>
